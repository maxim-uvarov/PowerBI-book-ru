...
Изначально, данное методическое пособие плод мук и страданий [Максима Уварова](https://maximuvarov.ru) в рамках [образовательного проекта NeedForData.ru](https://needfordata.ru/). Данное пособие призвано помочь начинающим пользователям Power BI, а также надстроек над Excel Power Query и Power Pivot, осваивать эти замечательные инструменты.

Авторы данного методического пособия не имеют отношения к корпорации Microsoft и ее продуктам Power BI, Excel, Power Query, Power Pivot. 

Пособие разделено на главы:  

1. Редактор запросов (Query Editor, он же **Power Query**)
2. Модель данных (Data Model, он же **Power Pivot**). 

Данное методическое пособие предлагается к использованию в режиме AS-IS (как есть), под лицензией GPL 3.0. Если вы используете материалы данного учебного пособия в своей документации или своих учебных пособиях, то вы обязательно должны (включая, но не ограничиваясь):
...
После этого члены редколлегии методического пособия смогут рассмотреть ваши предложения. 
...
- Record - запись  
	[field1 = "текст в кавычках",
	field2 = "текст в кавычках2"]
...
1. 4.	Выбираем страну, где в качестве разделителя используется точка (например, USA)
...
Есть клевый курс на Udacity
Link: [udemy.com/power-pivot-workshop-beginner/learn/v4/overview](https://www.udemy.com/power-pivot-workshop-beginner/learn/v4/overview)
...
Link: [amazon.com/Definitive-Guide-DAX-intelligence-Microsoft/dp/073569835X/ref=asap\_bc](https://www.amazon.com/Definitive-Guide-DAX-intelligence-Microsoft/dp/073569835X/ref=asap_bc?ie=UTF8)
**Daxpatterns.com**

Link: [daxpatterns.com/](http://www.daxpatterns.com/)